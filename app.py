...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'CHANGE_THIS_SECRET_KEY_BEFORE_PRODUCTION')
...
print("=" * 40)
print("Bot is running on BGX HOSTING")
...
def sitemap_xml():
    base = request.url_root.rstrip('/')
    urls = [f"{base}/", f"{base}/landing", f"{base}/login"]
